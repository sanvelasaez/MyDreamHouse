...
class PropietarioController extends AbstractController
{
    ...
    /**
     * @Route("/show/{id}", name="propietario_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/edit/{id}", name="propietario_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/delete/{id}", name="propietario_delete", methods={"DELETE"})
     */
